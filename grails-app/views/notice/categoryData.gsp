...
--}%
        ...
        <g:each in="${noticeInstanceList}" status="i" var="noticeInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td style="text-align: center">${fieldValue(bean: noticeInstance, field: "title")}</td>
                <g:if test="${session.user}">
                <td style="text-align: center"><g:link action="edit" resource="${noticeInstance}"><i class="edit icon"> </i><g:message code="default.button.edit.label" default="Edit" /></g:link>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <g:link action="delete" resource="${noticeInstance}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" > <i class="delete icon"></i>Delete </g:link>
